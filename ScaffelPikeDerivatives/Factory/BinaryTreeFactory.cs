...
namespace ScaffelPikeDerivatives.Factory
{
  ...
  {
    public static BinaryTree<State> CreateSecurityTree(double initialPrice, int time, double upFactor)
    {
    ...
    public static BinaryTree<State> CreateSecurityTree(double initialPrice, int time, double upFactor, double downFactor)
    {
